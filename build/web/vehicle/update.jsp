<%-- 
    Document   : update
    Created on : Mar 12, 2023, 7:03:26 PM
    Author     : User
--%>
                                ...
                                <div class="white_card_header">
                                    <div class="box_header m-0">
                                        <div class="main-title">
                                            <h3 class="m-0"> Update Vehicle</h3>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <form action="update" method="POST">
                                            <div class="row mb-3">
                                                    ...
                                                    <input type="hidden" class="form-control" id="inputID" value="${requestScope.vehicle.vehicle_id}" name="id">
                                                
                                                <div class="col-md-6">
                                                    <label class="form-label" for="inputName">Restaurant Name</label>
                                                    <input class="form-control" id="inputName" value="${requestScope.vehicle.vehicle_name}" name="name" minlength="3" maxlength="250" required>
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="form-label" for="inputName">Vehicle Name</label>
                                                    <input class="form-control" id="inputName" value="${requestScope.vehicle.vehicle_supplier}" name="supplier" maxlength="50" required>
                                                </div>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label" for="inputAddress">Address</label>
                                                <input type="text" class="form-control" id="inputAddress" placeholder="Address" value="${requestScope.vehicle.vehicle_address}" name="address" maxlength="250" required>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label" for="inputPhone">Phone</label>
                                                <input type="text" class="form-control" id="inputPhone" placeholder="Phone Number" value="${requestScope.vehicle.v_phonenumber}" name="phone" pattern="[0][0-9]{9}" required>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label" for="inputPhone">Email</label>
                                                <input type="email" class="form-control" id="inputEmail" placeholder="Email" value="${requestScope.vehicle.v_email}" name="email" required>
                                            </div>            
                                            <div class="mb-3">
                                                <label class="form-label" for="inputDescription">Description</label>
                                                <textarea type="text" class="form-control" id="inputDescription" placeholder="Write description here...." name="description" rows="5" cols="60" required>${requestScope.vehicle.v_description}</textarea> 
                                            </div>
                                            <br>

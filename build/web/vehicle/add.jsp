<%-- 
    Document   : add
    Created on : Mar 12, 2023, 7:03:16 PM
    Author     : User
--%>
                                ...
                                <div class="white_card_header">
                                    <div class="box_header m-0">
                                        <div class="main-title">
                                            <h3 class="m-0"> Create Vehicle</h3>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <form action="add" method="POST">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input class="form-control" id="inputName" name="name" minlength="3" maxlength="250" required>

                                                </div>

                                                <div class="col-md-6">
                                                    <label class="form-label" for="inputName">Supplier Name</label>
                                                    <input class="form-control" id="inputName" name="supplier" maxlength="50" required>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="email" class="form-control" id="inputPrice" placeholder="Email" name="email" required>

                                            </div>  

                                            <div class="mb-3">
                                                <label class="form-label" for="inputDescription">Description</label>
                                                <textarea type="text" class="form-control" id="inputDescription" placeholder="Write description here...." name="description" rows="5" cols="60"></textarea> 
                                            ...
                                            <div class="row mb-3">
                                                <div class=" col-md-6">
                                                    <label class="form-label" for="inputRate">Rate of Vehicle</label>
                                                    <div class="rate">
                                            ...
                                            <span id="spnError" class="error" style="display: none"><font color="red">Please select.</font></span>
                                            <style>
                                                *{
                                                    margin: 0;
                                                    padding: 0;

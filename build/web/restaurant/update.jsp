<%-- 
    Document   : update
    Created on : Feb 23, 2023, 10:01:09 PM
    Author     : User
--%>
                                ...
                                <div class="white_card_header">
                                    <div class="box_header m-0">
                                        <div class="main-title">
                                            <h3 class="m-0"> Update Restaurant</h3>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <select class="form-control" id="inputID">
                                                        ...
                                                        <c:forEach items="${requestScope.consciouses}" var="c">
                                                            <option <c:if test="${requestScope.restaurant.place.conscious.c_id eq c.c_id}">
                                                                    selected="selected"
                                                                </c:if>
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <select class="form-control" id="inputID" name="pid">
                                                        ...
                                                        <c:forEach items="${requestScope.places}" var="p">
                                                            <option <c:if test="${requestScope.restaurant.place.place_id eq p.place_id}">
                                                                    selected="selected"
                                                                </c:if>
                                                    ...
                                                    <input type="hidden" class="form-control" id="inputID" value="${requestScope.restaurant.res_id}" name="id">
                                                
                                                <div class="col-md-6">
                                                    <label class="form-label" for="inputName">Restaurant Name</label>
                                                    <input class="form-control" id="inputName" value="${requestScope.restaurant.res_name}" name="name">
                                                </div>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label" for="inputAddress">Address</label>
                                                <input type="text" class="form-control" id="inputAddress" placeholder="Address" value="${requestScope.restaurant.res_address}" name="address">
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label" for="inputPhone">Phone</label>
                                                <input type="text" class="form-control" id="inputPhone" placeholder="Phone Number" value="${requestScope.restaurant.res_phone}" name="phone">
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label" for="inputPrice">Average Price</label>
                                                <input type="text" class="form-control" id="inputPrice" placeholder="Average_price" value="${requestScope.restaurant.average_price}" name="price">
                                            </div>            
                                            <div class="mb-3">
                                                <label class="form-label" for="inputDescription">Introduction</label>
                                                <textarea type="text" class="form-control" id="inputDescription" placeholder="Write introduction here...." name="introduction" rows="5" cols="60">${requestScope.restaurant.introduction}</textarea> 
                                            </div>
                                            <br>

<%-- 
    Document   : add
    Created on : Feb 23, 2023, 1:34:43 PM
    Author     : User
--%>
                                ...
                                <div class="white_card_header">
                                    <div class="box_header m-0">
                                        <div class="main-title">
                                            <h3 class="m-0"> Create Restaurant</h3>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <form action="add" method="POST">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="file" class="form-control" id="inputImage" accept="image/*" name="image"  onchange="loadFile(event)">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="inputPrice" placeholder="Average_price" name="price">
                                            </div>            
                                            <div class="mb-3">
                                                <label class="form-label" for="inputDescription">Introduction</label>
                                                <textarea type="text" class="form-control" id="inputDescription" placeholder="Write introduction here...." name="introduction" rows="5" cols="60"></textarea> 
                                            </div>
                                            <br>
                                            <div class="row mb-3">
                                                <div class=" col-md-6">
                                                    <label class="form-label" for="inputRate">Rate of Restaurant</label>
                                                    <div class="rate">

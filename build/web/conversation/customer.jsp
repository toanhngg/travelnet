...
<head>
    ...
    <script>
            ...
            {
                window.alert("Travelnet sẽ liên hệ trong thời gian ngắn nhất. Cảm ơn quý khách!");
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-8">
					...
					<form name="form2" id="ff2" method="post" action="contact">				
						Email Address
						...
						<div class="form-group">
							<input type="tel" class="form-control" placeholder="Mobile :" name="phone" id="phone" required>
                                                ...
                                                Title
						<div class="form-group">
							<input type="text" class="form-control" placeholder="VD: Thanh toán bị lỗi" name="title" id="title" required>
						</div>
                                                Content
						<div class="form-group">
                                                    <input style="height: 120px" type="text" class="form-control" name="content" id="content" required>
						</div>
                                                <button type="submit" class="btn btn-4" onclick="notification()">Send</button>
					</form>
				</div>
			</div>
		</div>

<%-- 
    ...
    Created on : Feb 19, 2023, 4:19:43 PM
    Author     : admin
--%>
                            ...
                            <!--<div class="products">-->
                                <div style="display:flex;">
                                    <c:forEach items="${listA}" var="o">
                                        <!--<div class="product">-->
                                            <div class="image">
                                                <a href="booking?id=${o.tour_id}"><img src="${o.tour_image}" /></a>
                                                <ul class="buttons">
                                                    <li><a class="btn btn-2 cart" href="#"><span class="glyphicon glyphicon-shopping-cart"></span></a></li>
                                                    <li><a class="btn btn-2 wishlist" href="${o.tour_image}"><span class="glyphicon glyphicon-heart"></span></a></li>
                                                    <li><a class="btn btn-2 compare" href="#"><span class="glyphicon glyphicon-transfer"></span></a></li>
                                                </ul>
                                            </div>
                                            <div class="caption">
                                                <div class="name"><h3><a href="booking?id=${o.tour_id}">${o.tour_name}</a></h3></div>

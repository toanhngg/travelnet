<%-- 
    Document   : viewsearch
    Created on : Mar 17, 2023, 8:52:31 AM
    Author     : admin
--%>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <c:if test="${sessionScope.user.role_id == 4 or sessionScope.user.role_id == 1 }">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div id="main-content" class="col-md-8">
                        <c:if test="${empty requestScope.lstTourByName}">      
                            ${requestScope.report}
                        </c:if>
                        <c:if test="${not empty requestScope.lstTourByName}" >
                            <div class="row">
                                <div class="products">
                                  <c:forEach items="${lstTourByName}" var="o">
                                                ...
                                                <div class="product">
                                                    <div class="image">
                                                        ...
                                                        <ul class="buttons">
                                                            ...
                                                            <li><a class="btn btn-2 wishlist" href="favourite?fid=${o.tour_id}"><span class="glyphicon glyphicon-heart"></span></a></li>

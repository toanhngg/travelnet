        ...
        <header >
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6" >
                        <form class="form-search" style="display:flex;" action ="searchtour" method="post">  
                            <input  type="text" style="margin-top:2px;" name="search"  id="myInput" value="${searchtour}" onkeyup="myFunction()" placeholder="Enter Keywords?" class="input-medium search-query">
                            <div> 
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="category.html">Hot Tour</a></li>
                    </ul>
                </div>
            </div>
        </nav>
                ...
                <div class="row">
                    <div id="main-content" class="col-md-7">
                        <div class="product">
                            <div class="col-md-6">
                                <div class="image">
                                    <center><img style="margin:50px 0;" src="${sessionScope.tr.tour_image}" /></center>
                            ...
                            <div>
                                <div class="col-md-6">
                                    <div class="caption">
                                        <div class="name" style="text-align: center;"><h2 style="font-size: 30px;">${sessionScope.tr.tour_name}</h2></div>
                                        <div class="rating" style="text-align: center;"><span class="glyphicon glyphicon-star"></span><span class="glyphicon glyphicon-star"></span><span class="glyphicon glyphicon-star"></span><span class="glyphicon glyphicon-star"></span><span class="glyphicon glyphicon-star-empty"></span></div>
                                        <div class="info" style="text-align: center;">
                                            <ul>
                                                <li>Number of day : ${sessionScope.tr.number_of_days}</li>

                                            </ul>
                                        </div>
                                        <div class="price" style="text-align: center;">${sessionScope.tr.tour_price}đ</div>

                                        <div style="text-align: center;"><a onclick="notAllowToOrder(${sessionScope.tr.tour_id})"><button style="width: 60%; border-radius: 20px; margin: 30px;">Booking</button></a></div>
                                ...
                                <script>
                                    ...
                                    // Hàm đặt hàng
                                    function notAllowToOrder(id) {
                                        // Kiểm tra xem người dùng đã đăng nhập hay chưa
                                        if (!isLoggedIn) {
                                            alert('Vui lòng đăng nhập trước khi đặt tour.');
                                            return; // Dừng việc đặt hàng nếu người dùng chưa đăng nhập
                                        } else {
                                            window.location.href = "booking?tid=" + id;
                                        }

                                        // Tiếp tục đặt hàng nếu người dùng đã đăng nhập
                                        // Code tiếp theo để thực hiện đặt hàng
                                    }
                                </script>
                            </div>
                            <div class="clear"></div>
                        ...
                        <div class="product-desc">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="review-form">
                                    ...
                                    <form name="form" action="detail" method="post" onsubmit="return validateForm()">
                                        <c:forEach items="${requestScope.tour}" var="th">

                                            <c:forEach items="${requestScope.comment}" var="c">
                                                <c:if test="${c.tour.tour_id eq th.tour_id}">
                                                    <div class="comment-list">
                                                        <div class="comment clearfix">
                                                            <span class="name">${c.user.username} :</span>
                                                            <span class="comment-text">${c.ctitle} </span>
                                                                 <c:if test="${sessionScope.user.user_id == c.user.user_id}">
                                                                <div class="comment-actions">
                                                                    <a onclick="editComment(${c.cid})" class="glyphicon glyphicon-edit"></a>
                                                                    <a onclick="deleteComment(${c.cid})" class="glyphicon glyphicon-trash"></a>
                                                                </div><!-- comment -->
                                                            </c:if>
                                            ...
                                            <input type="hidden" name="tour_id" value="${sessionScope.tr.tour_id}">
                                ...
                                <script>
                                    function deleteComment(id)
                                    {
                                        var result = confirm("Are you sure?");
                                        if (result)
                                            window.location.href = "../view/deletereview?id=" + id;
                                    }
                                </script>
                                ...
                                <style>
                                    /* Căn phải các trường nhập liệu */
                                    input[type="text"], textarea {
                                        float: right;
                                    }

                                    /* Xóa float để các phần tử khác không bị ảnh hưởng */
                                    .clearfix:after {
                                        content: "";
                                        display: table;
                                        clear: both;
                                    ...
                                    /* Hiển thị các comment theo thứ tự mới nhất ở cuối danh sách */
                                    .comment-list {
                                        display: flex;
                                        flex-direction: column-reverse;
                                    }

                                    /* Định dạng từng comment */
                                    .comment {
                                        margin: 10px 0;
                                        padding: 10px;
                                        /*border: 1px solid #ccc;*/
                                    ...
                                    /* Định vị các nút Edit/Delete */
                                    .comment-actions {
                                        position: absolute;
                                        bottom: 5px; /* Cách đáy của phần tử cha */
                                        right: 5px; /* Cách bên phải của phần tử cha */
                                    }

                                    /* Định dạng các liên kết Edit/Delete */
                                    .comment-action-link {
                                        margin-left: 10px;
                                    }
                                </style>
                                <script>
                                    function validateForm() {
                                        ...
                                        if (userInput.trim().length === 0) {
                                            ...
                                            return false; // ngăn form được gửi đi nếu giá trị không hợp lệ
                                        } else {
                                            return true; // cho phép form được gửi đi nếu giá trị hợp lệ
                                        }
                                    }
                                </script>
                    ...
                    <div id="sidebar" class="col-md-5">
                        <div class="widget wid-categories" style="width: 60%; float: left;">
                            <div class="heading"><h4>CATEGORIES</h4></div>
                            <div class="content">
                                <ul>
                                    <c:forEach var="o" items="${sessionScope.lstCate}">                                                                              
                                        <li> <a href="listtourbycategory?categoryid=${o.tour_category_id}">${o.tour_category_name}</a></li>
                                        </c:forEach>

                    ...
                    <table class="table lms_table_active">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Total number of people</th>
                        ...
                        <tbody>
                            <c:forEach items="${requestScope.tour}" var="t" varStatus="loop">
                                <tr>

                                    <th scope="row"> <a href="#" class="question_content">${loop.index+1}</a></th>
                                    <td>    ${t.tour_name}</td>
                                    <td>${t.number_of_days}</td>
                                    <td>${t.number_people}</td>
                                    <td>${t.start_time}</td>
                                    <td>${t.status}</td>
                                 
                                    <td>
                                        <a class="glyphicon glyphicon-list-alt" href="../cartdetail?id=${t.tour_id}"></a>
                                    </td>
                                </tr>
                            </c:forEach>

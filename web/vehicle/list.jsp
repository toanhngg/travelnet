<%-- 
    Document   : list
    Created on : Mar 12, 2023, 7:03:07 PM
    Author     : User
--%>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12">
                            <div class="QA_section">
                                <div class="white_box_tittle list_header">
                                    ...
                                    <div class="box_right d-flex lms_block">
                                            ...
                                            <div class="search_inner col-md-8">
                                                <form class="form-search">  
                                                    <input value="${search}" type="text" class="input-medium search-query" name="search" 
                                                           id="myInput" onkeyup="myFunction()"   placeholder="Search vehicle here...">
                                        ...
                                        <div class="add_button ms-2">
                                            <a href="add" data-bs-toggle="modal" data-bs-target="#addcategory" class="btn_1">Add Vehicle</a>    
                                        </div>
                                ...
                                <div class="QA_table ">
                                    <div class="add_button ms-2">
                                        <button data-bs-toggle="modal" data-bs-target="#addcategory" class="btn_1" onclick="sortListDir()">Sort</button>
                                    </div>
                                    <table class="table lms_table_active" id="myTable">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">Vehicle Supplier</th>
                                        ...
                                        <tbody>
                                            <c:forEach items="${requestScope.vehicles}" var="v" varStatus="loop">
                                                <tr>
                                                    <th scope="row"> <a href="#" class="question_content">${loop.index+1}</a></th>

                                                    <td>${v.vehicle_id}</td>
                                                    <td>${v.vehicle_name}</td>
                                                    <td>${v.vehicle_address}</td>
                                                    <td>${v.vehicle_supplier}</td>
                                                    <td>${v.v_email}</td>
                                                    <td>${v.v_phonenumber}</td>
                                                    <c:if test="${v.v_rate == 0} " >
                                                        <td></td>                                                
                                                    </c:if>
                                                    <c:if test="${v.v_rate == 1} " >
                                                        <td><img src="../image(Nhi)/1 star.png" alt="alt"/></td>                                                
                                                        </c:if>
                                                        <c:if test="${v.v_rate == 2}">
                                                        <td><img src="../image(Nhi)/2 star.png" alt="alt"/></td>                                                
                                                        </c:if>
                                                        <c:if test="${v.v_rate == 3}">
                                                        <td><img src="../image(Nhi)/3 star.png" alt="alt"/></td>                                                
                                                        </c:if>
                                                        <c:if test="${v.v_rate == 4}">
                                                        <td><img src="../image(Nhi)/4 star.jpg" alt="alt"/></td>                                                
                                                        </c:if>
                                                        <c:if test="${v.v_rate == 5}">
                                                        <td><img src="../image(Nhi)/5 star.jpg" alt="alt"/></td>                                                
                                                        </c:if>
                                                    <td>
                                                        <a href="detail?id=${v.vehicle_id}"><img src="https://icons-for-free.com/download-icon-detail+details+ellipses+more+icon-1320183138163966322_512.png" ></a>
                                                    </td>
                                                    <td>
                                                        <a href="update?id=${v.vehicle_id}"><img src="https://icons.veryicon.com/png/o/miscellaneous/linear-small-icon/edit-246.png" ></a>
                                                    </td>
                                                    <td>
                                                        <a href="#" onclick="removeVehicle(${v.vehicle_id})"><img src="https://cdn2.iconfinder.com/data/icons/medical-and-health-2-16/65/64-512.png" ></a>
                                                    </td>
                                                </tr>
                                            </c:forEach>

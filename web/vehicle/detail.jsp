<%-- 
    Document   : detail
    Created on : Mar 20, 2023, 10:48:40 PM
    Author     : User
--%>
                ...
                <main class="mt-5 pt-4">
                    <div class="container mt-5">
                        ...
                        <div class="row">
                            ...
                            <h1><span> ${requestScope.vehicle.vehicle_supplier}</span></h1>
                            <!--Grid column-->
                            <div class="col-md-6 mb-4">

                                <br>
                                <img src="https://xesaigon.vn/wp-content/uploads/2020/10/cho-thue%CC%82-xe-du-li%CC%A3ch-tphcm.jpg" class="img-fluid" alt=""/>
                            </div>
                            <!--Grid column-->
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="p-4">
                                    <div class="mb-3">
                                        <strong><span style="font-size: 20px;">Vehicle ID:</span></strong>
                                        <span> ${requestScope.vehicle.vehicle_id}</span>
                                        <br>
                                        <br>
                                        <strong><span style="font-size: 20px;">Vehicle Name:</span></strong>
                                        <span>${requestScope.vehicle.vehicle_name}</span>
                                        <br>
                                        <br>
                                        <strong><span style="font-size: 20px;">Supplier Name:</span></strong>
                                        <span>${requestScope.vehicle.vehicle_supplier}</span>

                                        <br>
                                        <br>
                                        <strong><span style="font-size: 20px;">Vehicle Phone:</span></strong>
                                        <span> ${requestScope.vehicle.v_phonenumber}</span>
                                        <br>
                                        <br>
                                        <strong><span style="font-size: 20px;">Supplier Email:</span></strong>
                                        <span> ${requestScope.vehicle.v_email}</span>
                                        <br>
                                        <br>
                                        <strong><span style="font-size: 20px;"> Address:</span></strong>
                                        <span> ${requestScope.vehicle.vehicle_address}</span>
                                    </div>
                                    <br>
                                    ...
                                    <span style="font-size: 20px;">${requestScope.vehicle.v_description}</span>
                                </div>
                                <!--Content-->
                            </div>
                            <!--Grid column-->
                        ...
                        <hr />
                        <button onclick="history.back()" class="btn_1"> Back</button>

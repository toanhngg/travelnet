...
<!--                        <input type="hidden" name="tour_id" value="${sessionScope.tour_id}"/>-->
                        ...
                        <tbody>
                            <c:forEach items="${requestScope.order}" var="o" varStatus="loop">
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" onclick="cancelOrder(${o.order_id})">Cancel</a>
                                    </td>
                                </tr>
                            </c:forEach>
                ...
                <script>
                    ...
                    {
                        var result = confirm("Do you want cancel tour?");
                        if (result)
                            window.location.href = "view/cancel?id=" + id;
                    }
                </script>

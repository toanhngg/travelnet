<%-- 
    Document   : homepage
    Created on : Feb 17, 2023, 1:36:58 AM
    Author     : anhth
--%>
        ...
        <div id="page-content" class="home-page">
            <div class="container-fluid">
                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img style="width: 100%;height: 100vh;" src="../image/Forum/canh-dep-ha-noi-viet-nam_055419712.jpg" alt="First slide">
                                    <!-- Static Header -->
                                ...
                                <div class="item">
                                    <img style="width: 100%;height: 100vh;" src="../image/Forum/canh-dep-pho-co-hoi-an_055419868.jpg" alt="Second slide">
                                    <!-- Static Header -->
                                    <div class="header-text hidden-xs">
                                        <div class="col-md-12 text-center">
                                        </div>
                                ...
                                <div class="item">
                                    <img style="width: 100%;height: 100vh;" src="../image/Forum/canh-dep-hang-dong-viet-nam_055419790.jpg" alt="Third slide">
                                    <!-- Static Header -->
                                    <div class="header-text hidden-xs">
                                        <div class="col-md-12 text-center">
                                        </div>
                ...
                <div class="row">
                    <div class="banner">
                        <div class="col-sm-4">
                            <img style="height: 100%" src="../image/Forum/image.png" />
                        </div>
                        <div class="col-sm-4">
                            <img style="height: 100%" src="../image/Forum/canh-dep-dong-muoi-viet-nam_055419649.jpg" />
                        </div>
                        <div class="col-sm-4">
                            <img src="../image/Forum/anh-dep-nguoi-dan-vung-cao-viet-nam_055419258.jpg" />
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="tab-content">
                        <div id="featured" class="tab-pane fade in active">
                            <div class="products">
                                    ...
                                    <input type="hidden" name="t_id" value="${sessionScope.t_id}"/>
                                            <div class="col-sm-4">
                                                <div class="product">
                                                    <div class="image">
                                                        <a href="detail?id=${o.tour_id}"><img style="height: 250px; width: 100%" src="${o.tour_image}" /></a>
                                                        <ul class="buttons">
                                                            <li><a class="btn btn-2 cart" href="#"><span class="glyphicon glyphicon-shopping-cart"></span></a></li>
                                                            <li><a class="btn btn-2 wishlist" onclick="notAllowToOrder(${o.tour_id})"><span class="glyphicon glyphicon-heart"></span></a></li>
                                                            <li><a class="btn btn-2 compare" href="#"><span class="glyphicon glyphicon-transfer"></span></a></li>
                                                        </ul>
                                                    </div>
                                                    <div class="caption">
                                                        <div class="name"><h3><a href="detail?id=${o.tour_id}">${o.tour_name}</a></h3></div>
                                                        <div class="price">${o.tour_price}</div>
                                    ...
                                    function notAllowToOrder(id) {
                                        ...
                                        if (!isLoggedIn) {
                                            ...
                                            return; // Dừng việc đặt hàng nếu người dùng chưa đăng nhập
                                             ...
                                             window.location.href = "favourite?fid=" + id;
                                        }

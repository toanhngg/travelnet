<%-- 
    Document   : myfavoritelist
    Created on : Mar 13, 2023, 8:29:11 PM
    Author     : sofia
--%>
            ...
            <div class="container" style="width: 90%">
                ...
                <div class="row">
                    <div class="product well">
                        <c:forEach items="${wishlist}" var="v">
                            <div>
                                <div class="col-md-3">
                                    <div class="image">
                                        <a href="detail?id=${v.tour_id}"><img style="height: 240px; width: 100%" src="${v.tour_image}" /></a>
                                    </div>
                                </div>
                                <div class="col-md-9">
                                    <div class="caption">
                                        <div class="name"><h3 style="font-size: 30px;"><a href="detail?id=${v.tour_id}">${v.tour_name}</a></h3></div>
                                        <ul class="info">
                                            <li style="font-size: 20px;"><a href="detail?id=${v.tour_id}">${v.start_time}</a></li>
                                            <li style="font-size: 20px;">Number of days: <a href="detail?id=${v.tour_id}">${v.number_of_days}</a></li>
                                        </ul>
                                        <div class="price"><a href="detail?id=${v.tour_id}" style="color: #f44336;">${v.tour_price}đ</a></div>
                                        <div><a href="booking?id=${v.tour_id}"><button style="width: 30%; border-radius: 15px;">Booking</button></a>
                                            <a href="#" class="btn btn-default pull-right">REMOVE</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            <hr style="border: solid 1px; color: #ffcccc; margin: 25px 0;">
                        </c:forEach>
                        <div class="clear"></div>
                    </div>	
                </div>
                ...
                <div class="row">
                    <div class="col-md-4 col-md-offset-8 ">
                        <center><a href="homepage.jsp" class="btn btn-1">Continue To find Tour</a></center>
                    </div>
                </div>

<%-- 
    Document   : list
    Created on : Feb 23, 2023, 9:24:25 AM
    Author     : User
--%>
                            ...
                            <div class="QA_section">
                                <div class="white_box_tittle list_header">
                                    ...
                                    <div class="box_right d-flex lms_block">
                                            ...
                                            <div class="search_inner col-md-8">
                                                <form class="form-search">  
                                                    <input value="${search}" type="text" class="input-medium search-query" name="search" 
                                                        id="myInput" onkeyup="myFunction()"   placeholder="Search restaurant here...">
                                        ...
                                        <div class="add_button ms-2">
                                            <a href="add" data-bs-toggle="modal" data-bs-target="#addcategory" class="btn_1">Add Restaurant</a>    
                                        </div>
                                ...
                                <div class="QA_table ">
                                    ...
                                    <table class="table lms_table_active" id="myTable">
                                        ...
                                        <tbody>
                                            <c:forEach items="${requestScope.restaurants}" var="r" varStatus="loop">
                                                <tr>

                                                    <th scope="row"> <a href="#" class="question_content">${loop.index+1}</a></th>
                                                    <td>${r.place.conscious.c_name}</td>

                                                    <td>${r.res_id}</td>
                                                    <td><img src="${r.res_image}" alt="#"/></td>
                                                    <td>${r.res_name}</td>
                                                    <td>${r.res_address}</td>
                                                    <td>${r.res_phone}</td>
                                                    <c:if test="${r.res_rate == 0} " >
                                                        <td></td>                                                
                                                    </c:if>
                                                    <c:if test="${r.res_rate == 1} " >
                                                        <td><img src="../image(Nhi)/1 star.png" alt="alt"/></td>                                                
                                                        </c:if>
                                                        <c:if test="${r.res_rate == 2}">
                                                        <td><img src="../image(Nhi)/2 star.png" alt="alt"/></td>                                                
                                                        </c:if>
                                                        <c:if test="${r.res_rate == 3}">
                                                        <td><img src="../image(Nhi)/3 star.png" alt="alt"/></td>                                                
                                                        </c:if>
                                                        <c:if test="${r.res_rate == 4}">
                                                        <td><img src="../image(Nhi)/4 star.jpg" alt="alt"/></td>                                                
                                                        </c:if>
                                                        <c:if test="${r.res_rate == 5}">
                                                        <td><img src="../image(Nhi)/5 star.jpg" alt="alt"/></td>                                                
                                                        </c:if>
                                                        <td>
                                                            <a href="detail?id=${r.res_id}"><img src="https://icons-for-free.com/download-icon-detail+details+ellipses+more+icon-1320183138163966322_512.png" ></a>
                                                    </td>
                                                    <td>
                                                        <a href="update?id=${r.res_id}"><img src="https://icons.veryicon.com/png/o/miscellaneous/linear-small-icon/edit-246.png" ></a>
                                                    </td>
                                                    <td>
                                                        <a href="#" onclick="removeRestaurant(${r.res_id})"><img src="https://cdn2.iconfinder.com/data/icons/medical-and-health-2-16/65/64-512.png" ></a>
                                                    </td>
                                                </tr>
                                            </c:forEach>

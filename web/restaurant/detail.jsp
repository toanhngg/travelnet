<%-- 
    Document   : detail
    Created on : Mar 20, 2023, 10:32:07 PM
    Author     : User
--%>
                ...
                <main class="mt-5 pt-4">
                    <div class="container mt-5">
                        ...
                        <div class="row">
                            ...
                            <h1><span> ${requestScope.restaurant.res_name}</span></h1>
                            <!--Grid column-->
                            <div class="col-md-6 mb-4">

                                <br>
                                <img src="${requestScope.restaurant.res_image}" alt="#"/>
                            </div>
                            <!--Grid column-->
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="p-4">
                                    <div class="mb-3">
                                        <strong><span style="font-size: 20px;">Restaurant ID:</span></strong>
                                        <span> ${requestScope.restaurant.res_id}</span>
                                        <br>
                                        <br>
                                        <strong><span style="font-size: 20px;">Restaurant Name:</span></strong>
                                        <span>${requestScope.restaurant.res_name}</span>
                                        <br>
                                        <br>
                                        <strong><span style="font-size: 20px;">Restaurant Price:</span></strong>
                                        <span>${requestScope.restaurant.average_price}</span>
                                        <br>
                                        <br>
                                        <strong><span style="font-size: 20px;">Restaurant Phone:</span></strong>
                                        <span> ${requestScope.restaurant.res_phone}</span>
                                        <br>
                                        <br>
                                        <strong><span style="font-size: 20px;">Restaurant Address:</span></strong>
                                        <span> ${requestScope.restaurant.res_address}</span>
                                    </div>
                                    <br>
                                    ...
                                    <span style="font-size: 20px;">${requestScope.restaurant.introduction}</span>
                                </div>
                                <!--Content-->
                            </div>
                            <!--Grid column-->

<%-- 
    Document   : detail
    Created on : Mar 20, 2023, 8:36:10 PM
    Author     : User
--%>
                ...
                <main class="mt-5 pt-4">
                    <div class="container mt-5">
                        ...
                        <div class="row">
                            ...
                            <h1><span> ${requestScope.hotel.hotel_name}</span></h1>
                            <!--Grid column-->
                            <div class="col-md-6 mb-4">

                                <br>
                                <img src="${requestScope.hotel.hotel_img}" alt="#"/>
                            </div>
                            <!--Grid column-->
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="p-4">
                                    <div class="mb-3">
                                        <strong><span style="font-size: 20px;">Hotel ID:</span></strong>
                                        <span> ${requestScope.hotel.hotel_id}</span>
                                        <br>
                                        <br>
                                        <strong><span style="font-size: 20px;">Hotel Name:</span></strong>
                                        <span>${requestScope.hotel.hotel_name}</span>
                                        <br>
                                        <br>
                                        <strong><span style="font-size: 20px;">Hotel Type:</span></strong>
                                        <span>${requestScope.hotel.hotel_type}</span>

                                        <br>
                                        <br>
                                        <strong><span style="font-size: 20px;">Hotel Phone:</span></strong>
                                        <span> ${requestScope.hotel.hotel_phone}</span>
                                        <br>
                                        <br>
                                        <strong><span style="font-size: 20px;">Hotel Address:</span></strong>
                                        <span> ${requestScope.hotel.hotel_address}</span>
                                    </div>

                                    <strong><span style="font-size: 20px;">Description: </span></strong>
                                    <br>

                                    <span style="font-size: 20px;">${requestScope.hotel.hotel_description}</span>
                                </div>
                                <!--Content-->
                            </div>
                            <!--Grid column-->

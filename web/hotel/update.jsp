<%-- 
    Document   : update
    Created on : Feb 22, 2023, 8:59:47 PM
    Author     : User
--%>
                                        ...
                                        <form action="update" method="POST">
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <select class="form-control" id="inputID">
                                                        ...
                                                        <c:forEach items="${requestScope.consciouses}" var="c">
                                                            <option <c:if test="${requestScope.hotel.place.conscious.c_id eq c.c_id}">
                                                                    selected="selected"
                                                                </c:if>
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <select class="form-control" id="inputID" name="pid">
                                                        <option selected="">Select District</option>
                                                        <c:forEach items="${requestScope.places}" var="p">
                                                            <option <c:if test="${requestScope.hotel.place.place_id eq p.place_id}">
                                                                    selected="selected"
                                                                </c:if>
                                                                value="${p.place_id}">${p.place_name}</option>
                                                        </c:forEach>

                                                    </select>
                                                </div>
                                                
                                                    <input type="hidden" class="form-control" id="inputID" name="id" value="${requestScope.hotel.hotel_id}">
                                                
                                                <div class="col-md-6">
                                                    <label class="form-label" for="inputName">Hotel Name</label>
                                                    <input class="form-control" id="inputName" value="${requestScope.hotel.hotel_name}" name="name">
                                                </div>
                                            </div>
                                            <br>
                                            <div class="row mb-3">
                                                <div class=" col-md-6">
                                                    <label class="form-label" for="inputType">Type of Hotel</label>
                                                    <div class="type">
                                                        <input type="radio" id="star5"
                                                               <c:if test="${requestScope.hotel.hotel_type == 5 }">
                                                                   checked="checked"
                                                               </c:if>
                                                               name="type" value="5" />
                                                        ...
                                                        <img src="../image(Nhi)/type 1 star.jpg" alt=""/>
                                                        <img src="../image(Nhi)/type 1 star.jpg" alt=""/>
                                                        <label for="star5" title="5 sao">5 stars</label> <br>
                                                        <input type="radio" id="star4" 
                                                               <c:if test="${requestScope.hotel.hotel_type == 4}">
                                                                   checked="checked"
                                                               </c:if>
                                                               name="type" value="4" />   
                                                        <img src="../image(Nhi)/type 1 star.jpg" alt=""/>
                                                        ...
                                                        <img src="../image(Nhi)/type 1 star.jpg" alt=""/>
                                                        <img src="../image(Nhi)/type 1 star.jpg" alt=""/>
                                                        <label for="star4" title="4 sao">4 stars</label> <br>
                                                        <input type="radio" id="star3" 
                                                               <c:if test="${requestScope.hotel.hotel_type == 3}">
                                                                   checked="checked"
                                                               </c:if>
                                                               name="type" value="3" />
                                                        <img src="../image(Nhi)/type 1 star.jpg" alt=""/>
                                                        <img src="../image(Nhi)/type 1 star.jpg" alt=""/>
                                                        <img src="../image(Nhi)/type 1 star.jpg" alt=""/>
                                                        <label for="star3" title="3 sao">3 stars</label> <br>
                                                        <input type="radio" id="star2" 
                                                               <c:if test="${requestScope.hotel.hotel_type == 2}">
                                                                   checked="checked"
                                                               </c:if>
                                                               name="type" value="2" />
                                                        <img src="../image(Nhi)/type 1 star.jpg" alt=""/>
                                                        <img src="../image(Nhi)/type 1 star.jpg" alt=""/>
                                                        <label for="star2" title="2 sao">2 stars</label> <br>
                                                        <input type="radio" id="star1"
                                                               <c:if test="${requestScope.hotel.hotel_type == 1}">
                                                                   checked="checked"
                                                               </c:if>
                                                               name="type" value="1" />
                                                        <img src="../image(Nhi)/type 1 star.jpg" alt=""/>
                                                        <label for="star1" title="1 sao">1 star</label> <br>
                                                    </div>
                                                </div>
                                            </div> 
                                            <div class="mb-3">
                                                <label class="form-label" for="inputAddress">Address</label>
                                                <input type="text" class="form-control" id="inputAddress" placeholder="Address" value="${requestScope.hotel.hotel_address}" name="address">
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label" for="inputPhone">Phone</label>
                                                <input type="text" class="form-control" id="inputPhone" placeholder="Phone Number" value="${requestScope.hotel.hotel_phone}" name="phone">
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label" for="inputDescription">Description</label>
                                                <textarea type="text" class="form-control" id="inputDescription" placeholder="Description" name="description" rows="4" cols="50" >${requestScope.hotel.hotel_description}</textarea> 
                                            </div>

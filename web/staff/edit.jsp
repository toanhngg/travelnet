                                    ...
                                    <div class="card-body">
                                        <form action="add" method="POST">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="inputAddress" placeholder="username" name="username" value="${param.value}" required/>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label" for="inputAddress">Password</label>
                                                <input type="text" class="form-control" id="inputAddress" placeholder="First name" name="password" required />
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label" for="inputAddress">First Name</label>
                                                <input type="text" class="form-control" id="inputAddress" placeholder="First name" name="firstname" required/>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-file" for="inputPhone">Last Name</label>
                                                <input type="text" class="form-control" id="inputAddress" placeholder="Last name" name="lastname" required/>
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="row mb-3">
                                                <div class=" col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="inputType" name="nationality" required />
                                                </div>
                                            </div> 
                                            <div class="row mb-3">
                                                <div class=" col-md-6">
                                                    <label class="form-label" for="inputType">National ID</label>
                                                    <input type="text" class="form-control" id="inputType" name="national_id" required/>
                                                </div>
                                            </div> 
